...
public class BTFarmingTokenDropEvent extends Event implements Cancellable {
    ...
    public BTFarmingTokenDropEvent(Player p, double tokens, double multiplierTokens, double percentageTokens, Block block){
        this.player= p;
        this.multiplierTokens = multiplierTokens;
        this.percentageTokens = percentageTokens;
        this.tokens = tokens;
